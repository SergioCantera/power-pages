...
export const Winner = ({winner, reset}:WinnerProps) => {
  if (winner !== null) {
  return (
          <section className="absolute w-lvw h-lvh top-0 left-0 grid place-items-center bg-gray-800/80 z-10">
            <div className="bg-gray-900 h-[300px] w-[320px] border-2 border-gray-100 rounded-xl flex flex-col justify-center items-center gap-5">
              <h2 className='text-gray-100'>{winner === false ? 'Empate' : 'Ganador '}</h2>
